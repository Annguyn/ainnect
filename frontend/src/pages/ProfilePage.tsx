...
import type { User, SocialStats } from '../types';
...
const ProfilePage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'posts' | 'about' | 'education' | 'experience' | 'interests' | 'locations'>('about');
      ...
      <main className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 mb-6 overflow-hidden">
          <div className="h-48 relative">
            {completeProfile?.coverUrl ? (
              ...
              <div className="h-full bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500">
          ...
          <div className="px-6 pb-6">
            <div className="flex flex-col lg:flex-row lg:items-end lg:space-x-8">
              <div className="relative -mt-20 mb-4 lg:mb-0">
                <div className="w-32 h-32 rounded-2xl border-4 border-white bg-white shadow-2xl overflow-hidden">
                  <Avatar
                ...
                {isCurrentUserProfile && (
                  <button className="absolute -bottom-2 -right-2 p-2 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg transition-all duration-200">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                  <div className="flex-1">
                    ...
                    {profileUser?.bio && (
                      <p className="text-gray-700 mb-4 max-w-2xl leading-relaxed">{profileUser.bio}</p>
                    )}
                  ...
                  <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                      ...
                      <div className="text-sm text-blue-700 font-medium">Bài viết</div>
                    </div>
                    
                    <button 
                      onClick={() => navigate(`/followers/${targetUserId}`)}
                      className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-xl hover:from-green-100 hover:to-green-200 transition-colors"
                    >
                      <div className="text-2xl font-bold text-green-600">
                        {completeProfile?.socialStats?.followersCount || 0}
                      </div>
                      <div className="text-sm text-green-700 font-medium">Người theo dõi</div>
                    </button>
                    
                    <button 
                      onClick={() => navigate(`/following/${targetUserId}`)}
                      className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl hover:from-purple-100 hover:to-purple-200 transition-colors"
                    >
                      <div className="text-2xl font-bold text-purple-600">
                        {completeProfile?.socialStats?.followingCount || 0}
                      </div>
                      <div className="text-sm text-purple-700 font-medium">Đang theo dõi</div>
                    </button>
                    
                    <button 
                      onClick={() => navigate(`/friends/${targetUserId}`)}
                      className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl hover:from-orange-100 hover:to-orange-200 transition-colors"
                    >
                      <div className="text-2xl font-bold text-orange-600">
                        {completeProfile?.socialStats?.friendsCount || 0}
                      </div>
                      <div className="text-sm text-orange-700 font-medium">Bạn bè</div>
                    </button>
                  </div>
                  ...
                  <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center p-4 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl">
                      <div className="text-2xl font-bold text-indigo-600">
                        {completeProfile.educations?.length || 0}
              </div>
                      <div className="text-sm text-indigo-700 font-medium">Trường học</div>
            </div>
                    <div className="text-center p-4 bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl">
                      <div className="text-2xl font-bold text-emerald-600">
                        {completeProfile.workExperiences?.length || 0}
                      </div>
                      <div className="text-sm text-emerald-700 font-medium">Kinh nghiệm</div>
                    </div>
                    <div className="text-center p-4 bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl">
                      <div className="text-2xl font-bold text-amber-600">
                        {completeProfile.interests?.length || 0}
                      </div>
                      <div className="text-sm text-amber-700 font-medium">Sở thích</div>
                    </div>
                    <div className="text-center p-4 bg-gradient-to-br from-rose-50 to-rose-100 rounded-xl">
                      <div className="text-2xl font-bold text-rose-600">
                        {completeProfile.locations?.length || 0}
                      </div>
                      <div className="text-sm text-rose-700 font-medium">Địa điểm</div>
                    </div>
                  </div>
                  )}
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div key={i} className="aspect-square bg-gray-200 rounded-lg flex items-center justify-center">
                    <span className="text-gray-400 text-sm">Ảnh {i}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="aspect-square bg-gray-200 rounded-lg flex items-center justify-center">
                    <span className="text-gray-400 text-xs">Bạn {i}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <nav className="flex border-b border-gray-200 overflow-x-auto">
            ...
            <button
              onClick={() => {
                debugLogger.logButtonClick('Profile Tab', { tab: 'about' });
                setActiveTab('about');
              }}
              className={`flex-shrink-0 py-4 px-6 text-center font-semibold text-sm transition-all duration-200 ${
                activeTab === 'about'
          ...
          <div className="space-y-6">
            ...
            {profileUser?.bio && (
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                ...
                <p className="text-gray-700 leading-relaxed text-lg">{profileUser.bio}</p>
              </div>
            )}
                ...
                {profileUser && (
                  <ProfileOverview
                    ...
                    isEditable={isCurrentUserProfile || false}
                  />
            )}
          </div>
        )}
