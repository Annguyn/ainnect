...
public interface PostService {
	PostDtos.Response create(PostDtos.CreateRequest request);
	...
	// Comments
	Long addComment(Long postId, PostDtos.CommentCreateRequest request);

	Page<com.ainnect.entity.Comment> listComments(Long postId, Pageable pageable);

	// Reactions
	void reactToPost(Long postId, PostDtos.ReactionRequest request);

	void unreactToPost(Long postId, Long userId);

	// Share
	Long sharePost(Long postId, PostDtos.ShareRequest request);
}
